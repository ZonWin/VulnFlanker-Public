...
Before using the Agent, build the Linux binaries first. The public repository
does not ship prebuilt Agent executables by default, and the installation
commands generated by the console expect these binary artifacts to be available.
